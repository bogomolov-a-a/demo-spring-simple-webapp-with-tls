  ...
  public TestRestTemplate getSecureRestTemplate(String keyStoreFile, String trustedKeystoreType, String keyStorePass, String keyPass) {
    ...
    builder.requestFactory(() -> {
      try {
        ...
        keyStore.load(inputStream, Objects.requireNonNull(keyStorePass).toCharArray());

        SSLConnectionSocketFactory socketFactory = new SSLConnectionSocketFactory(
            new SSLContextBuilder().loadTrustMaterial(null, new TrustSelfSignedStrategy()).loadKeyMaterial(keyStore, keyPass.toCharArray()).build(),
