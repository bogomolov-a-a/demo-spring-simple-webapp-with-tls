...
internal class AuthorityEntityTest : AbstractAccessorEntityTest<Authority>(
    ...
    override fun buildStandardEntity(): Authority = Authority(NAME_VALUE)
    ...
    override fun containFieldCorrectValuesTest(standardEntity: Authority) {
        ...
        //Assertions.assertEquals(DESCRIPTION_VALUE, standardEntity.)
    }

    override fun buildAnotherEntityForTest(): Authority = Authority(NAME_ANOTHER_VALUE)
